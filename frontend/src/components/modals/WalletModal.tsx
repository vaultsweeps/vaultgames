...
const paymentMethods = [
  ...
  { id: 'apple',   name: 'Apple Pay',      icon: '',   badge: '-5%',     color: 'bg-black', logoUrl: 'https://i.pinimg.com/originals/ae/85/92/ae859253f4141e38711d2c159a53649e.jpg' },
  { id: 'card',    name: 'Debit Card',     icon: '💳', badge: '-10%',    color: 'bg-blue-600' },
